...
namespace ice::output
{
    ...
    public:
        ...
        virtual void add_callback(ice::input::EntityType type, std::function<void(std::shared_ptr<ice::input::Entity> const&)> callback) noexcept = 0;

        //! \brief Calls all callbacks for the given entity.
        virtual void handle_entity(std::shared_ptr<ice::input::Entity> const& entity) const noexcept = 0;
    };
