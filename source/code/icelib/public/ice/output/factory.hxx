...
namespace ice::output
{
    ...
    public:
        ...
        virtual auto create(const Line& line_data) noexcept -> std::unique_ptr<ASTElement> = 0;
        ...
        virtual auto create(const Alias& alias_data) noexcept -> std::unique_ptr<ASTElement> = 0;

        virtual auto create(const Enum& enum_data) noexcept -> std::unique_ptr<ASTElement> = 0;

        virtual auto create(const CodeBlock& codeblock_data) noexcept -> std::unique_ptr<ASTContainer> = 0;

        virtual auto create(const Namespace& namespace_data) noexcept -> std::unique_ptr<ASTContainer> = 0;

        virtual auto create(const UserType& usertype_data) noexcept -> std::unique_ptr<ASTContainer> = 0;

        virtual auto create(const AccessSpecifier& usertype_data) noexcept -> std::unique_ptr<ASTContainer> = 0;
